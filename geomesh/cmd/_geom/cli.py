...
# from ... import db
# from .. import CliComponent, _common
...
#             _common.add_cache_to_parser(tmp_parser)
...
#         metavar='yaml_file'
#     )
#     _common.add_log_level_to_parser(parser)
#     _common.add_cache_to_parser(parser)
#     _common.add_nprocs_to_parser(parser)
